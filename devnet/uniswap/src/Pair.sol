...
contract Pair {
    ...
    // LP token
    string public constant name = "Torus LP";
    ...
    function mint(address to) external lock returns (uint256 liquidity) {
        ...
        if (totalSupply == 0) {
            ...
            _mintLP(address(1), MINIMUM_LIQUIDITY); // permanently lock
        } else {
            liquidity = _min(
    ...
    function swap(uint256 amount0Out, uint256 amount1Out, address to, bytes calldata) external lock {
        ...
        require(balance0Adjusted * balance1Adjusted >= uint256(_reserve0) * uint256(_reserve1) * 1_000_000, "K");
